...
std::pair<int,std::vector<int>> Diag_Scalapack_gvx::pdsygvx_once(
...
void Diag_Scalapack_gvx::pdsygvx_diag(
	const int*const desc,
	const int ncol,
	const int nrow,
	const double*const h_mat,
...
void Diag_Scalapack_gvx::pzhegvx_diag(
	const int*const desc,
	const int ncol,
	const int nrow,
	const std::complex<double>*const h_mat,
...
void Diag_Scalapack_gvx::post_processing(const int info, const std::vector<int> &vec)
{
