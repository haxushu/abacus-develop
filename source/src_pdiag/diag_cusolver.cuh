...
//This file contains constructor and destructor of the class Diag_Cusolver_gvd, 
//as well as other public subroutines 

    Diag_Cusolver_gvd();
    ~Diag_Cusolver_gvd();
    void finalize();  // for recycling the usage of the static class Diag_Cusolver_gvd
    
//Apart from the constructor and the destructor, it contains 2 types of subroutines:

//1. subroutines that are related to initializing the class:
...
//2. subroutines that are related to calculating generalized eigenvalues and eigenvectors for dense matrix pairs:
