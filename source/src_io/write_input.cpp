...
void Input::Print(const std::string &fn)const
{
	...
	ModuleBase::GlobalFunc::OUTP(ofs,"stru_file",GlobalV::stru_file,"the filename of file containing atom positions");
	...
	ModuleBase::GlobalFunc::OUTP(ofs,"pseudo_mesh",pseudo_mesh,"0: use our own mesh to do radial renormalization; 1: use mesh as in QE");
	...
	ModuleBase::GlobalFunc::OUTP(ofs,"smearing_method",smearing_method,"type of smearing_method: gauss; fd; fixed; mp; mp2; mv");
